...
namespace NBA_2K13_Workarounds_Tool
{
    ...
    public partial class App : Application
    {
        private void Application_DispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
        {
            ...
            try
            {
                var f = new StreamWriter(NBA_2K13_Workarounds_Tool.MainWindow.DocsPath + @"\errorlog_unh.txt");
            ...
            MessageBox.Show("NBA 2K13 Workarounds Tool encountered a critical error and will be terminated.\n\nAn Error Log has been saved at " +
                            NBA_2K13_Workarounds_Tool.MainWindow.DocsPath + @"\errorlog_unh.txt");
            try
            {
                Process.Start(NBA_2K13_Workarounds_Tool.MainWindow.DocsPath + @"\errorlog_unh.txt");
            }
            catch (Exception)
            {
